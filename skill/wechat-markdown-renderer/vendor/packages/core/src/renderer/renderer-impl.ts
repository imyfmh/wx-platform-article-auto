import type { ExtendedProperties, IOpts, ThemeStyles } from '../../../shared/src/types/common.ts'
import type { RendererAPI } from '../../../shared/src/types/renderer-types.ts'
...
import { markedAlert } from '../extensions/alert.ts'
import { markedFootnotes } from '../extensions/footnotes.ts'
import { MDKatex } from '../extensions/katex.ts'
import { markedPlantUML } from '../extensions/plantuml.ts'
import { markedRuby } from '../extensions/ruby.ts'
import { markedSlider } from '../extensions/slider.ts'
import { markedToc } from '../extensions/toc.ts'
import { getStyleString } from '../utils/themeHelpers.ts'
